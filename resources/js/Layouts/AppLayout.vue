                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('users.index')" :active="route().current('users.index')" v-if="$page.props.auth.user.role_id == 1">
                                    Manager
                                </NavLink>
                                <NavLink :href="route('users.index')" :active="route().current('users.index')" v-if="$page.props.auth.user.role_id == 2">
                                    Staff
                                </NavLink>
                                <NavLink :href="route('venues.index')" :active="route().current('venues.index')" v-if="$page.props.auth.user.role_id == 2">
                                    Venue
                                </NavLink>
<!--                                <NavLink :href="route('roles.index')" :active="route().current('roles.index')" v-if="$page.props.auth.user.role_id == 1">-->
<!--                                    Roles-->
<!--                                </NavLink>-->
                                <NavLink :href="route('staff.venues.list')" :active="route().current('staff.venues.list')" v-if="$page.props.auth.user.role_id == 3">
                                    Venue
                                </NavLink>
                            </div>
                        </div>
