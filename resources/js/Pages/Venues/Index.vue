	...
	<AppLayout title="Venue">
		...
		<template #header>
			<h2 class="flex justify-between text-xl font-semibold leading-tight text-gray-800">
                ...
                <div>
                    <inertia-link href="venues/create">
                        <a
					...
					<table class="min-w-full divide-y divide-gray-200">
						...
						<tbody class="bg-white divide-y divide-gray-200">
							<tr v-for="venue in venues.data" :key="venue.id">
								...
								<td class="px-6 py-4 whitespace-nowrap">
									<div class="text-sm text-center text-gray-900">
										<a :href="'mailto:' + venue.email_address">{{ venue.email_address }}</a>
									</div>
								</td>
								...
								<td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    <inertia-link :href="`/venues/assign/${venue.id}`"
                                                  class="float-left px-4 py-2 text-orange-600 duration-100 rounded hover:text-orange-600">
                                        <i class="fa fa-user"/>
                                    </inertia-link>
									...
									<a href="#" @click="deleteVenue(venue)"
